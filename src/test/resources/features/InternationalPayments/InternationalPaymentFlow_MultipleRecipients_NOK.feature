@intlmultiplepayments @nok
Feature: End to End International payment flow with Multiple Recipients - NOK

  Background:
    Given I setup test data file name for "InternationalPayments_Multiple" "NOK" "60"
...
#    And I verify "Available" balance of "<fromCurrency>" wallet after submitting Foreign Exchange to CAB
    ...
    Examples:
      ...
      | AED          | NOK        |  1-2 business days   |2 business days| +91 7989730020 |  BUSINESS          | INDIVIDUAL          |                      |