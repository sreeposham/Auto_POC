@intlmultiplepayments @eur @multitenor
Feature: End to End International payment flow with Multiple Recipients - EUR

  Background:
    Given I setup test data file name for "InternationalPayments_Multiple" "EUR" "60"

  @corp
  Scenario Outline: Verify the end to end flow of International payments with Multiple recipients for EUR corridor
...
#    And I verify "Available" balance of "<fromCurrency>" wallet after submitting Foreign Exchange to CAB
    ...
    Examples:
      ...
      | AED          | EUR        |  Within 1 business day   |2 business days| +91 7989730020 |  BUSINESS          | INDIVIDUAL          |                      |