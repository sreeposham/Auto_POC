@intlmultiplepayments @sgd @multitenor
Feature: End to End International payment flow with Multiple Recipients - SGD

  Background:
    Given I setup test data file name for "InternationalPayments_Multiple" "SGD" "60"

  @corp
  Scenario Outline: Verify the end to end flow of International payments with Multiple recipients for SGD corridor
...
#    And I verify "Available" balance of "<fromCurrency>" wallet after submitting Foreign Exchange to CAB
    ...
    Examples:
      ...
      | AED          | SGD        |  1-2 business days   |Next business day| +91 7989730020 |  BUSINESS          | INDIVIDUAL          |                      |