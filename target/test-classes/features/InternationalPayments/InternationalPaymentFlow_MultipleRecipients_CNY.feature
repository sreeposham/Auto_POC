@intlmultiplepayments @cny
Feature: End to End International payment flow with Multiple Recipients - CNY

  Background:
    Given I setup test data file name for "InternationalPayments_Multiple" "CNY" "60"
