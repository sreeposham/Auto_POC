@intlmultiplepayments @chf @multitenor
Feature: End to End International payment flow with Multiple Recipients - CHF

  Background:
    Given I setup test data file name for "InternationalPayments_Multiple" "CHF" "60"

  @corp
  Scenario Outline: Verify the end to end flow of International payments with Multiple recipients for CHF corridor
...
#    And I verify "Available" balance of "<fromCurrency>" wallet after submitting Foreign Exchange to CAB
    ...
    Examples:
      ...
      | AED          | CHF        |  1-2 business days   |2 business days| +91 7989730020 |  BUSINESS          | INDIVIDUAL          |                      |