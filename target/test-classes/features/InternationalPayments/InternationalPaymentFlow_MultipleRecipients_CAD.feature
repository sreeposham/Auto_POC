@intlmultiplepayments @cad @multitenor
Feature: End to End International payment flow with Multiple Recipients - CAD

  Background:
    Given I setup test data file name for "InternationalPayments_Multiple" "CAD" "60"

  @corp
  Scenario Outline: Verify the end to end flow of International payments with Multiple recipients for CAD corridor
...
#    Then I verify "ANITHA TEST BUSINESS Solutions Private Limited" company name and "Sreekanth j" full name on the page
    ...
    When I select "<tenor>" tenor on Exchange page
...
#    And I verify "Available" balance of "<fromCurrency>" wallet after submitting Foreign Exchange to CAB
    ...
    Examples:
      | fromCurrency | toCurrency |  processingTime |tenor| phone          |  recipientBusiness | recipientIndividual | transactionReference |
      | AED          | CAD        |  Within 1 business day   |Next business day| +91 7989730020 |  BUSINESS          | INDIVIDUAL          |                      |